                            ...
                            <form role="form" action = "add_vote.php" method="post">
                                <fieldset>
                                    ...
                                    <?php
                                    	...
                                    	<?php echo "<input class='form-control' placeholder='Please enter option description' <name=".'opt'.$i." type='text'>" ?>
                                    	</div>
                                    <?php } ?>

                                  	<div class="form-group">
                                		<?php  echo "<input class='form-control' type='hidden' value=".$i.">" ?>
                                	</div>
