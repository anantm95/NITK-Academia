        ...
        <div style="margin-top:50px;" class="col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">
            <div class="login-panel panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title">Set up a group formation</h3>
                </div>
                <div class="panel-body">
                    <form role="form" action = "add_group.php" method="post">
                        <fieldset>
                            <div class="form-group">
                                <label for="inputgrouptitle">Group Title</label>
                                <input class="form-control" placeholder="Please enter the group title" name="group_title" type="text">
                            </div>
                            <div class="form-group">
                                <label for="inputnummembers">Number of members</label>
                                <input class="form-control" placeholder="Please enter the number of members in each group" name="num_members" type="number">
                            </div>
